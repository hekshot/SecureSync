...
public class SecurityConfigurer {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173","http://internation.com","https://internation.int.cyraacs.in","http://internation.int.cyraacs.in","https://internation-hekshot.int.cyraacs.in"));
