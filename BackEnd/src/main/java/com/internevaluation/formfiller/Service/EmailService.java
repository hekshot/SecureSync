...
public class EmailService {
    ...
    @Async
    public void sendFileAcceptedEmail(User user)
            throws MessagingException, UnsupportedEncodingException {
        String toAddress = user.getEmail();
        ...
        String content = "<p><span style=\"font-family: helvetica, arial, sans-serif; font-size: medium;\"><strong>Dear " + user.getEmail() + ",</strong></span></p>\n" +
                "<p><span style=\"font-family: helvetica, arial, sans-serif; font-size: medium;\">Congratulations! Your file has been approved by <strong>admin.&nbsp;</strong></span></p>\n" +
    ...
    @Async
    public void sendFileRejectedEmail(User user, String remarks) throws MessagingException, UnsupportedEncodingException {
        String toAddress = user.getEmail();
        String fromAddress = "internation@gmail.com";
        String senderName = "Internation Team";
        ...
        String content = "<p><span style=\"font-family: helvetica, arial, sans-serif; font-size: medium;\"><strong>Dear ...,</strong></span></p>\n" +
                "<p><span style=\"font-family: helvetica, arial, sans-serif; font-size: medium;\">Your file has been <strong><span style=\"color: #ff0000;\">rejected</span> </strong>by <strong>admin.&nbsp;</strong></span></p>\n" +
                "<p style=\"margin-left: 30px;\">Remarks: " + remarks + "</p>\n" +
                "<p>&nbsp;</p>\n" +
    ...
    @Async
    public void sendFileDeletedEmail(User user)
            throws MessagingException, UnsupportedEncodingException {
        String toAddress = user.getEmail();
        String fromAddress = "internation@gmail.com";
        String senderName = "Internation Team";
        ...
        String content = "<p><span style=\"font-family: helvetica, arial, sans-serif; font-size: medium;\"><strong>Dear ...,</strong></span></p>\n" +
                "<p><span style=\"font-family: helvetica, arial, sans-serif; font-size: medium;\">Your file has been <strong><span style=\"color: #008000;\">deleted</span></strong> successfully.</span></p>\n" +
